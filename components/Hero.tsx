...
const Hero = () => {
  ...
  return (
    ...
    <div className="absolute inset-0 overflow-hidden">
      ...
      <div className="absolute bottom-0 left-1/2 -translate-x-1/2 w-[40rem] h-[20rem] 
      ...
      >
        <div className="container mx-auto px-4">
          <motion.div className="max-w-3xl mx-auto" variants={staggerChildren}>
            ...
            {/* Search & CTA Section */}
            <motion.div
              className="w-full max-w-3xl mx-auto mt-12 flex flex-col md:flex-row md:items-start justify-center gap-6"
              variants={fadeInUp}
            >
