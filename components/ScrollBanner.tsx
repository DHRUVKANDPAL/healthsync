...
const ScrollingAnnouncement = () => {
  return (
    <div className="relative w-full h-14 overflow-hidden bg-gradient-to-r from-violet-600 to-violet-700 dark:bg-gradient-to-r dark:from-slate-800 dark:to-slate-900 shadow-lg">
      ...
      <div className="absolute inset-y-0 left-0 w-8 bg-gradient-to-r from-violet-600 to-transparent z-10 dark:bg-gradient-to-r dark:from-slate-800 dark:to-transparent" />
      <div className="absolute inset-y-0 right-0 w-8 bg-gradient-to-l from-violet-700 to-transparent z-10 dark:bg-gradient-to-l dark:from-slate-900 dark:to-transparent" />
