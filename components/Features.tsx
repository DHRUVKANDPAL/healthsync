...
const FeatureCard = ({
  ...
  <div className="bg-white bg-opacity-90 rounded-lg shadow-md p-6 flex flex-col items-center text-center transition-all duration-300 hover:shadow-lg hover:-translate-y-1 backdrop-blur-sm">
