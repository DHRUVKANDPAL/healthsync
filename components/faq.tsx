...
const Faq = () => {
  return (
   ...
   <AccordionItem value="item-1">
     <AccordionTrigger>How do I register as a patient on the platform?
     </AccordionTrigger>
     <AccordionContent>
   ...
   <AccordionItem value="item-2">
     <AccordionTrigger>What is the process for registering a hospital or doctor on the platform?
     </AccordionTrigger>
     <AccordionContent>
   ...
   <AccordionItem value="item-3">
     <AccordionTrigger>What should I do if I need immediate medical attention?
     </AccordionTrigger>
     <AccordionContent>
   ...
   <AccordionItem value="item-4">
     <AccordionTrigger>How can I book an appointment with a specialist?
   ...
   <AccordionItem value="item-5">
     <AccordionTrigger>What documents are needed for hospital registration?
   ...
   <AccordionItem value="item-6">
     <AccordionTrigger>What support is available if I encounter issues during registration?
