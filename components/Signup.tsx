...
export const SignUpSchema = z
  .object({
    ...
    aadharno: z.string(),
    bloodgroup: z.string(),
    contactno: z.string().length(10,"This is not a vaid contact no"),
    alternatecontactno: z.string().length(10,"This is not a vaid contact no"),
    address: z.string(),
    emregencycontact: z.string().length(10,"This is not a vaid contact no"),
    prevHis: z.string(),
