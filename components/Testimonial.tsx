            ...
            <div className="p-1 w-full">
              <Card>
                <CardContent className="flex aspect-square items-center justify-center px-4 h-84  md:h-80 w-full">
                  <CardHeader>
                    <CardTitle className="font-semibold text-lg">Rajiv Verma</CardTitle>
          ...
          <CarouselItem className="sm:basis-1/2 lg:basis-1/3">
            <div className="p-1">
              <Card>
                <CardContent className="flex aspect-square items-center justify-center px-4 h-84  md:h-80 w-full">
                  <CardHeader>
                    <CardTitle className="font-semibold text-lg">Anita Sharma</CardTitle>
                    <CardDescription className="font-medium">
          ...
          <CarouselItem className="sm:basis-1/2 lg:basis-1/3">
            <div className="p-1">
              <Card>
                <CardContent className="flex aspect-square items-center justify-center px-4 h-84  md:h-80 w-full">
                  <CardHeader>
                    <CardTitle className="font-semibold text-lg">Rohan Mehta</CardTitle>
                    <CardDescription className="font-medium">
          ...
          <CarouselItem className="sm:basis-1/2 lg:basis-1/3">
            <div className="p-1">
              <Card>
                <CardContent className="flex aspect-square items-center justify-center px-4 h-84  md:h-80 w-full">
                  <CardHeader> 
                    <CardTitle className="font-semibold text-lg">Priya Singh</CardTitle>
                    <CardDescription className="font-medium">
          ...
          <CarouselItem className="sm:basis-1/2 lg:basis-1/3">
            <div className="p-1">
              <Card>
                <CardContent className="flex aspect-square items-center justify-center px-4 h-84  md:h-80 w-full">
                  <CardHeader>
                    <CardTitle className="font-semibold text-lg">Vikram Patel</CardTitle>
                    <CardDescription className="font-medium">
          ...
          <CarouselItem className="sm:basis-1/2 lg:basis-1/3">
            <div className="p-1">
              <Card>
                <CardContent className="flex aspect-square items-center justify-center px-4 h-84  md:h-80 w-full">
                  <CardHeader>
                    <CardTitle className="font-semibold text-lg">Sanjana Rao</CardTitle>
                    <CardDescription className="font-medium">
